//! # craton-crypto: Cryptographic primitives for `Craton`
//!
//! This crate provides the cryptographic foundation for `Craton`'s
...
//!
//! ```
//! use craton_crypto::{chain_hash, ChainHash, SigningKey, internal_hash, HashPurpose};
//! use craton_crypto::{EncryptionKey, WrappedKey};
//!
