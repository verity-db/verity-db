...
///
/// ```
/// use craton_crypto::anonymize::redact;
///
...
///
/// ```
/// use craton_crypto::anonymize::{mask, MaskStyle};
///
/// // Fixed replacement
...
///
/// ```
/// use craton_crypto::anonymize::{truncate_date, DatePrecision};
///
...
///
/// ```
/// use craton_crypto::anonymize::generalize_age;
///
...
///
/// ```
/// use craton_crypto::anonymize::generalize_zip;
///
...
///
/// ```
/// use craton_crypto::anonymize::generalize_numeric;
///
...
///
/// ```
/// use craton_crypto::anonymize::check_k_anonymity;
///
