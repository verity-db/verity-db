//! Error types for the Verity SDK.
//!
...
use thiserror::Error;
use vdb_kernel::KernelError;
use vdb_query::QueryError;
use vdb_storage::StorageError;
use vdb_store::StoreError;
use vdb_types::{Offset, StreamId, TenantId};

/// Result type for Verity operations.
pub type Result<T> = std::result::Result<T, VerityError>;

/// Errors that can occur during Verity operations.
#[derive(Debug, Error)]
