//! # craton-sim: Deterministic Simulation Testing for `Craton`
//!
//! This crate provides a VOPR-style (Viewstamped Operation Replication)
//! simulation harness for testing `Craton` under controlled conditions.
//!
//! ## Philosophy
//!
...
//!
//! ```ignore
//! use craton_sim::{Simulation, SimConfig};
//!
