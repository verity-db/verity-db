//! # craton-vsr: Viewstamped Replication for `Craton`
//!
//! This crate implements the Viewstamped Replication (VSR) consensus protocol
//! for `Craton`, enabling distributed replication with guaranteed data durability
//! and consistency.
//!
//! ## Overview
//!
...
//!          ▼
//! ┌─────────────────┐
//! │  craton-kernel     │  Pure state transition, produce Effects
//! └─────────────────┘
//! ```
//!
//! ## Key Components
...
//!
//! ```ignore
//! use craton_vsr::{ClusterConfig, ReplicaId, Superblock, MemorySuperblock};
//!
