...
use craton_kernel::{Command, Effect, KernelError, State, apply_committed};
...
///
/// ```ignore
/// use craton_vsr::{SingleNodeReplicator, ClusterConfig, ReplicaId, MemorySuperblock};
...
mod tests {
    ...
    fn kernel_error_propagates() {
        ...
        let bad_command = Command::append_batch(
            craton_types::StreamId::new(999), // Non-existent
