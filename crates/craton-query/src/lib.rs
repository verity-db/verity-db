//! # craton-query: SQL query layer for `Craton` projections
//!
...
//!
//! ```ignore
//! use craton_query::{QueryEngine, Schema, SchemaBuilder, ColumnDef, DataType, Value};
//! use craton_store::{BTreeStore, TableId};
//!
//! // Define schema
...
use craton_store::ProjectionStore;
